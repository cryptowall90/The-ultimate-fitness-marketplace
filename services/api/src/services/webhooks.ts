...
/**
 * Routes one verified event payload to its handler. Shared by the live
 * webhook path above and the dead-letter reprocessor (reconciliation job).
 * Returns false for event types we deliberately ignore.
 */
